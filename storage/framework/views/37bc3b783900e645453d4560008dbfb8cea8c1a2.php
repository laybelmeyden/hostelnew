<?php $__env->startSection('page_title', __('voyager.database.edit_bread_for_table', ['table' => (isset($dataType->id) ? @$dataType->name : $table)])); ?>

<?php $__env->startSection('page_header'); ?>
    <div class="page-title">
        <i class="voyager-data"></i>
        <?php echo e(__('voyager.database.edit_bread_for_table', ['table' => (isset($dataType->id) ? @$dataType->name : $table)])); ?>
                ...
                <?php endif; ?>
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="voyager-bread"></i> <?php echo e(ucfirst($table)); ?> <?php echo e(__('voyager.database.bread_info')); ?></h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.display_name_singular')); ?></label>
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="<?php echo e(__('voyager.database.display_name_singular')); ?>"
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.display_name_plural')); ?></label>
                                    <?php if($isModelTranslatable): ?>
                                        <?php echo $__env->make('voyager::multilingual.input-hidden', [
                                            'isModelTranslatable' => true,
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="<?php echo e(__('voyager.database.display_name_plural')); ?>"
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.url_slug')); ?></label>
                                    <input type="text" class="form-control" name="slug" placeholder="<?php echo e(__('voyager.database.url_slug_ph')); ?>"
                                           value="<?php if(isset($dataType->slug)): ?><?php echo e($dataType->slug); ?><?php else: ?><?php echo e($slug); ?><?php endif; ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.icon_hint')); ?> <a
                                                href="<?php echo e(route('voyager.compass.index', [], false)); ?>#fonts"
                                                target="_blank"><?php echo e(__('voyager.database.icon_hint2')); ?></a></label>
                                    <input type="text" class="form-control" name="icon"
                                           placeholder="<?php echo e(__('voyager.database.icon_class')); ?>"
                                           value="<?php if(isset($dataType->icon)): ?><?php echo e($dataType->icon); ?><?php endif; ?>">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.model_name')); ?></label>
                                    <span class="voyager-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="<?php echo e(__('voyager.database.model_name_ph')); ?>"></span>
                                    <input type="text" class="form-control" name="model_name" placeholder="<?php echo e(__('voyager.database.model_class')); ?>"
                                           value="<?php if(isset($dataType->model_name)): ?><?php echo e($dataType->model_name); ?><?php else: ?><?php echo e($model_name); ?><?php endif; ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.controller_name')); ?></label>
                                    <span class="voyager-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="<?php echo e(__('voyager.database.controller_name_hint')); ?>"></span>
                                    <input type="text" class="form-control" name="controller" placeholder="<?php echo e(__('voyager.database.controller_name')); ?>"
                                           value="<?php if(isset($dataType->controller)): ?><?php echo e($dataType->controller); ?><?php endif; ?>">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="email"><?php echo e(__('voyager.database.policy_name')); ?></label>
                                    <span class="voyager-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="<?php echo e(__('voyager.database.policy_name_ph')); ?>"></span>
                                    <input type="text" class="form-control" name="policy_name" placeholder="<?php echo e(__('voyager.database.policy_class')); ?>"
                                           value="<?php if(isset($dataType->policy_name)): ?><?php echo e($dataType->policy_name); ?><?php endif; ?>">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="generate_permissions"><?php echo e(__('voyager.database.generate_permissions')); ?></label><br>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="server_side"><?php echo e(__('voyager.database.server_pagination')); ?></label><br>
                            ...
                            <div class="form-group">
                                <label for="description"><?php echo e(__('voyager.database.description')); ?></label>
                                <textarea class="form-control" name="description"
                                          placeholder="<?php echo e(__('voyager.database.description')); ?>"
                    ...
                    <div class="panel panel-primary panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="voyager-window-list"></i> <?php echo e(__('voyager.database.edit_rows', ['table' => $table])); ?>:</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row fake-table-hd">
                                ...
                                <div class="col-xs-2"><?php echo e(__('voyager.database.display_name')); ?></div>
                            ...
                            <?php if(isset($dataTypeRelationships)): ?>
                                <?php $__currentLoopData = $dataTypeRelationships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('voyager::tools.database.relationship-partial', $relationship, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
...
<?php echo $__env->make('voyager::tools.database.relationship-new-modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
